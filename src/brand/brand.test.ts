...
function snap(p: Partial<StyleSnapshot>): StyleSnapshot {
  return {
    ...
    lineHeight: 24, letterSpacing: '0', textTransform: 'none', fontStyle: 'normal', fontStretch: 'normal', fontVariantNumeric: 'normal', fontFeatureSettings: 'normal', fontVariationSettings: 'normal', fontOpticalSizing: 'auto', wordSpacing: '0', radius: 0, shadow: '', paddingTop: 0, paddingLeft: 0,
...
function input(light: StyleSnapshot[], dark: StyleSnapshot[], defaultBackground: string) {
  return { light, dark, mobile: [], defaultBackground, fontFaces: [], fontFiles: [], hoverAccents: [], extraGradients: [], measure: 0, signals: { elementCount: light.length, title: '', textLength: 5000 } };
}
...
test('brand: a bot/challenge page is flagged with near-zero confidence', () => {
  const brand = assembleBrand({
    light: [], dark: [], mobile: [], defaultBackground: 'rgb(255,255,255)', fontFaces: [], fontFiles: [], hoverAccents: [], extraGradients: [], measure: 0,
